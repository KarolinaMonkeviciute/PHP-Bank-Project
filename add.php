...
<body>
         ...
         <li class="list-group-item">
            <div class="container">
                <div class="row mb-2">
                    ...
                    <div class="col-3">
                    <form action="http://localhost/bit/U2/update.php?id=<?=$acc['id']?>" method="post">
                        <input style="width: 60%" type="text" name="add" placeholder="Iveskite suma" ></input>
                        <button type="submit" class="btn btn-outline-success custom-button">Pridėti</button>
                    </form>
                </div>
            </div>
        </li>
   ...
   <?php endforeach ?>
        <?php else : ?>
        <form class="new-form" action="http://localhost/bit/U2/update.php?id=<?=$acc['id']?>" method="post">
            ...
            <input type="text" name="add" placeholder="Iveskite suma"></input>
